...
export default function TxHashTableFiltersResult({
  filters,
  onFilters,
  //
  onResetFilters,
  ...
  return (
    <Stack spacing={1.5} {...other}>
      ...
      <Stack flexGrow={1} spacing={1} direction="row" flexWrap="wrap" alignItems="center">
        ...
        {filters.startDate && (
          <Block label="시작일:">
            <Chip size="small" label={fDate(filters.startDate)} onDelete={handleRemoveStartDate} />
          </Block>
        )}

        {filters.endDate && (
          <Block label="종료일:">
            <Chip size="small" label={fDate(filters.endDate)} onDelete={handleRemoveEndDate} />
          </Block>
        )}
