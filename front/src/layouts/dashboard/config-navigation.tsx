...
const ICONS = {
  ...
  board: <Iconify icon="icon-park-outline:volume-notice" sx={{ width: 1, height: 1 }} />,
  faq: <Iconify icon="wpf:faq" sx={{ width: 1, height: 1 }} />,
  contact: <Iconify icon="mingcute:question-line" sx={{ width: 1, height: 1 }} />,
  policy: <Iconify icon="carbon:policy" sx={{ width: 1, height: 1 }} />,
};
    ...
    () => [
      ...
      // BOARD
      {
        ...
        items: [
          ...
          {
            title: '화이트리스트 인증',
            path: paths.dashboard.board.list,
            icon: ICONS.blog,
          }
        ],
      },
